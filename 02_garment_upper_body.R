...
# Plot 1: Distribution of Colour Group Codes
...
# Save the plot
ggsave(paste0(output_directory_path, "02_colour_group_code_distribution.png"), plot = p1, width = 10, height = 8) # nolint

# Plot 2: Distribution of Graphical Appearance Numbers
p2 <- ggplot(garment_upper_body_articles, aes(x = factor(graphical_appearance_no))) + # nolint
  geom_bar(fill = "blue") +
...
# Save the plot
ggsave(paste0(output_directory_path, "02_graphical_appearance_distribution.png"), plot = p2, width = 10, height = 8) # nolint
