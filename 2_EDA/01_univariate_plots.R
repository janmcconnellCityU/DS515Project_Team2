...
# Univariate Analysis for articles.csv

# Plot 1: Distribution of Product Group Names
p1 <- ggplot(articles, aes(x = product_group_name)) +
  geom_bar(fill = "blue") +
  theme_minimal() +
...
p2 <- ggplot(articles, aes(x = factor(colour_group_code))) +
  geom_bar(fill = "blue") +
  theme_minimal() +
...
# Save the plot
ggsave(paste0(output_directory_path, "01_colour_group_code_distribution.png"), plot = p2, width = 10, height = 8) # nolint

# Plot 3: Distribution of Graphical Appearance Numbers
p3 <- ggplot(articles, aes(x = factor(graphical_appearance_no))) +
  geom_bar(fill = "blue") +
  theme_minimal() +
...
# Save the plot
ggsave(paste0(output_directory_path, "01_graphical_appearance_distribution.png"), plot = p3, width = 10, height = 8) # nolint
...
# Save the plot
ggsave(paste0(output_directory_path, "01_club_member_status_distribution.png"), plot = p2, width = 10, height = 8) # nolint
...
# Save the plot
ggsave(paste0(output_directory_path, "01_fashion_news_frequency_distribution.png"), plot = p3, width = 10, height = 8) # nolint

# Univariate Analysis for transactions_train.csv

# Plot 1: Distribution of Prices
p1 <- ggplot(transactions_train, aes(x = price)) +
...
p2 <- ggplot(transactions_train, aes(x = factor(sales_channel_id))) +
  geom_bar(fill = "blue") +
  theme_minimal() +
...
# Save the plot
ggsave(paste0(output_directory_path, "01_sales_channel_id_distribution.png"), plot = p2, width = 10, height = 8) # nolint
